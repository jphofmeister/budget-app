...
const DialogBoxConfirmation = props => {
  ...
  const dialogBoxOpen =
    isEmpty(props) === false && isEmpty(props.dialogBoxOpen) === false ? props.dialogBoxOpen : "";
  const dialogBoxType =
    isEmpty(props) === false && isEmpty(props.dialogBoxType) === false ? props.dialogBoxType : ""; // * confirmDelete -- 07/15/2021
  const dialogBoxSize =
    isEmpty(props) === false && isEmpty(props.dialogBoxSize) === false ? props.dialogBoxSize : ""; // * sm, md, lg, xl -- 07/15/2021
  const dialogBoxTitle =
    isEmpty(props) === false && isEmpty(props.dialogBoxTitle) === false ? props.dialogBoxTitle : "";
  const dialogBoxContent =
    isEmpty(props) === false && isEmpty(props.dialogBoxContent) === false
      ? props.dialogBoxContent
      : "";

  const setDialogBoxContinue =
    isEmpty(props) === false && isEmpty(props.setDialogBoxContinue) === false
      ? props.setDialogBoxContinue
      : noFunctionAvailable;
