...
const DialogBox = props => {
  ...
  const setDialogBoxOpen =
    isEmpty(props) === false && isEmpty(props.setModalOpen) === false
      ? props.setModalOpen
      : noFunctionAvailable;

  const size = dialogBoxSize;
  const title = dialogBoxTitle;
  const content = dialogBoxContent;
