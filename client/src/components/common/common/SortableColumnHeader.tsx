...
const SortableColumnHeader = props => {
  ...
  const columnText =
    isEmpty(props) === false && isEmpty(props.columnText) === false ? props.columnText : "";
  const columnPropertyName =
    isEmpty(props) === false && isEmpty(props.columnPropertyName) === false
      ? props.columnPropertyName
      : "";
  const sortDirection =
    isEmpty(props) === false && isEmpty(props.sortDirection) === false ? props.sortDirection : "";
  const sortProperty =
    isEmpty(props) === false && isEmpty(props.sortProperty) === false ? props.sortProperty : "";

  const setSortDirection =
    isEmpty(props.setSortDirection) === false ? props.setSortDirection : noFunctionAvailable;
  const setSortProperty =
    isEmpty(props.setSortProperty) === false ? props.setSortProperty : noFunctionAvailable;
