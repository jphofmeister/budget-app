...
import { isEmpty, getDateTime, displayDate, isNonEmptyArray, convertYesNoTrueFalse } from "shared-functions";
...
const CalendarItemPopover = (props) => {
  ...
  let travelStartDateString = isEmpty(currentEvent) === false /*&& isEmpty(currentEvent.calendarStartDate) === false*/ ? new Date(currentEvent.calendarStartDate).toLocaleDateString("en-CA") : "";
  let travelEndDateString = isEmpty(currentEvent) === false /*&& isEmpty(currentEvent.calendarEndDate) === false*/ ? new Date(currentEvent.calendarEndDate).toLocaleDateString("en-CA") : "";
  ...
  return (
    <div className={popoverContainerClasses}>
      ...
      <div className="event-popover" style={{ borderTopColor: `${eventColor}` }}>
        ...
        {isEmpty(loggedInUser) === false && isEmpty(partnerName) === false ?
        ...
        {isEmpty(loggedInUser) === false && isEmpty(request.conferenceName) === false ?
